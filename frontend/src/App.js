...
import { Users, Calendar as CalendarIcon, Settings, DollarSign, Clock, Download, Plus, Edit, Trash2, Check, CheckSquare, Copy, User, LogOut } from 'lucide-react';
import './App.css';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      {!isAuthenticated ? (
        ...
        <Dialog open={showLoginDialog && !isAuthenticated} onOpenChange={() => {}}>
          <DialogContent className="max-w-md" closable={false}>
            ...
            <div className="space-y-4">
              ...
              <div>
                <Label htmlFor="login-pin">PIN (4 or 6 digits)</Label>
                <Input
                  id="login-pin"
                  type="password"
                  value={loginData.pin}
                  onChange={(e) => setLoginData({...loginData, pin: e.target.value.replace(/\D/g, '').slice(0, 6)})}
        ...
        {/* Change PIN Dialog */}
        <Dialog open={showChangePinDialog} onOpenChange={() => {}}>
          <DialogContent className="max-w-md" closable={false}>
            <DialogHeader>
              <DialogTitle className="text-center">
                🔑 Change Your PIN
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setChangePinData({...changePinData, current_pin: e.target.value.replace(/\D/g, '').slice(0, 6)})}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setChangePinData({...changePinData, new_pin: e.target.value.replace(/\D/g, '').slice(0, 6)})}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setChangePinData({...changePinData, confirm_pin: e.target.value.replace(/\D/g, '').slice(0, 6)})}
