...
class PinResetStaffTester:
    ...
    def authenticate_as_admin(self):
        ...
        login_data = {
            "username": "Admin",
            "pin": "0370"  # Updated PIN from previous test
        }
    ...
    def test_pin_reset_real_email(self):
        ...
        # First, create an active staff member for this test
        test_staff = {
            "id": "",  # Will be auto-generated by backend
            "name": "Alice Johnson",
        ...
        success, staff_response = self.run_test(
            "Create Active Staff for PIN Reset Test",
            "POST",
            "api/staff",
            200,
            data=test_staff
        ...
        if not success:
            print("   ❌ Could not create test staff member")
            return False
        
        # Test with Alice Johnson using generated email pattern
        # The backend auto-creates user accounts for staff with generated emails
        staff_email = "alicejohnson@company.com"  # Generated from "Alice Johnson"
        ...
        success, response = self.run_test(
            "Reset PIN with Generated Email Pattern for Alice Johnson",
            "POST",
            "api/admin/reset_pin",
            200,
            data=reset_request,
        ...
        if success:
            ...
            # Verify username was generated correctly
            if username and username == "alicejohnson":
                print(f"   ✅ Username generated correctly from staff name")
            else:
                print(f"   ❌ Username generation incorrect: {username}")
                return False
